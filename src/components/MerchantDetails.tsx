          ...
          <div className="col-lg-12">
                ...
                <div className="col-xs-12 social-btns">
                    ...
                    <div className="col-xs-3 col-md-1 col-lg-1 social-btn-holder">
                      <a className="btn btn-social btn-block btn-stackoverflow" href="#">
                        <i className="fa fa-stack-overflow"/> </a>
                    </div>
            ...
            <div className="col-xs-12 col-sm-8">
              <ul className="list-group">
                ...
                <li className="list-group-item"><i className="fa fa-phone"/> {merchant.phone} </li>
                <li className="list-group-item"><i className="fa fa-envelope"/> {merchant.email}</li>
              </ul>
            </div>            
          </div>
